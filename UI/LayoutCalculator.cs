...
internal static class LayoutCalculator
{
        ...
        float keyboardPanelHeight)
    {
        ...
        float sliderRowOneY = controlPanel.Y + 106;
        float sliderRowTwoY = controlPanel.Y + 162;
        ...
        return new LayoutMetrics(controlPanel, waveformPanel, keyboardPanel, sliderRowOneY, sliderRowTwoY, sliderWidth, waveformButtonsArea);
    }
}
